...
contains
    ...
    subroutine apply_diffusion(in_field, out_field, alpha, num_iter)
        ...
        ! Initialize tmp1_field and tmp2_field if not allocated
    ...
    subroutine laplacian(field, lap, num_halo, extend)
        ...
        ! Parallelized loop for Laplacian calculation
        !$omp parallel do private(i,j,k) collapse(3)
        do k = 1, nz
