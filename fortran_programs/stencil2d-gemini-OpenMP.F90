...
contains
    ...
    subroutine apply_diffusion(in_field, out_field, alpha, num_iter)
      ...
      ! ... (allocate and initialize tmp1_field and tmp2_field as before)

      do iter = 1, num_iter
        ! Update halo zone of in_field
        call update_halo(in_field)

        ! Calculate Laplacian of in_field
    ...
    "I chose to keep update_halo as it was, this could be changed"
