...
contains
    ...
    subroutine apply_diffusion(in_field, out_field, alpha, num_iter)
        ...
        ! Allocate 2D arrays for tmp1_field and tmp2_field
        ...
        do iter = 1, num_iter
            ...
            ! Swap fields if not the last iteration
